...
5. Give the binary Wifi capability permissions `sudo setcap cap_net_admin+ep serviceberry-cli-linux-x86_64` -- you may need to run as root if this doesn't work
